...
int main(int argc, char** argv) {
    ...
    fprintf(result, "],\n  \"operation_count\": %" PRIu64 ",\n  \"latency_ns_per_operation\": %.17g,\n  \"throughput_operations_per_second\": %.17g,\n  \"encoded_byte_size\": %zu,\n  \"resources\": {\"encoded_bytes\": %zu, \"object_size\": %zu, \"allocations\": 0, \"allocated_bytes\": 0},\n  \"validation_status\": \"passed\",\n  \"checksum\": %" PRIu64 "\n}\n", (uint64_t)((double)count * iterations * samples), latency, 1e9 / latency, sizes[0], sizes[0], sizeof(benchmark_workload_Workload_t), checksum);
