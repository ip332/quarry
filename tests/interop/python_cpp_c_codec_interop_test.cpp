...
constexpr std::string_view kCHarness =
    ...
    "  sample->has_Optional = true; sample->Optional = 7U;\n"
    ...
    "  if (!v->has_Optional || v->Optional != 7U) return 2;\n"
...
constexpr std::string_view kCppHarness =
    ...
    "  if (!builder.set_Optional(7U)) return false;\n"
...
constexpr std::string_view kPythonHarness =
    ...
    "def make_sample():\n"
    "    return Sample(\n"
    "        flag=True, Optional_=7, i8=-5, u8=250, i16=-1000, u16=60000, i32=-100000,\n"
