...
quarry_brf_get_value(&record, 0, &value);
```
...
element type is a record; string/bytes arrays use the same count-plus-length
framing as the scalar variable-width array model.
